...
@implementation RecentScrollViewController
...
- (void)loadView {
	...
	recentView  = [[RecentView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, self.view.bounds.size.height)];
